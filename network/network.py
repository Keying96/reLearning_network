...
if __name__ == '__main__':
    checkpoint_directory = "/home/zhu/PycharmProjects/reLearning_network" \
                           "/checkpoint/Sony/model.ckpt"
    ...
    #
    model = network(256) #输入图像尺寸的最小值：256
    # checkpoint = tf.train.Checkpoint(model = model)
    # # checkpoint.restore(checkpoint_directory)
